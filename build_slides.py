...
slides.append("""
        ...
        <div class="center-layout abs-element" style="width: 90%; display: flex; justify-content: space-between; top: 55%;">
            <div class="dashboard-card" style="width: 31%; height: 400px; border-color: #00ffcc; text-align: left;">
                <h3 style="color: #00ffcc; text-align: center; font-size: 24pt; margin-bottom: 20px;">Khối Kiến thức</h3>
            ...
            <div class="dashboard-card" style="width: 31%; height: 400px; border-color: #ffeb3b; text-align: left;">
                <h3 style="color: #ffeb3b; text-align: center; font-size: 24pt; margin-bottom: 20px;">Khối Kỹ năng</h3>
                <ul style="font-size: 18pt; line-height: 1.8; color: #fff; margin-left: 20px;">
            ...
            <div class="dashboard-card" style="width: 31%; height: 400px; border-color: #ff3333; text-align: left;">
                <h3 style="color: #ff3333; text-align: center; font-size: 24pt; margin-bottom: 20px;">Khối Thái độ</h3>
                <ul style="font-size: 18pt; line-height: 1.8; color: #fff; margin-left: 20px;">
                    <li>Sử dụng AI trung thực.</li>
                    <li>Không phụ thuộc vào AI.</li>
                </ul>
            </div>
        </div>
""")
...
slides.append("""
        ...
        <div class="center-layout abs-element dashboard-card alert-box" style="width: 75%; text-align: center; border-color: #ff3333; animation: flash-alert 0.5s infinite alternate; background: rgba(50,0,0,0.8);">
            <div class="body-text editable draggable" style="font-size: 20pt; color: #ffeb3b; font-weight: bold; line-height: 1.8;">
                Trung tâm Điều phối Công nghệ phát hiện nhiều học sinh đang dùng AI làm hộ bài tập.<br><br>
                <span style="color: #ff3333; font-size: 24pt;">Hệ thống cảnh báo: "Mức độ phụ thuộc AI đang tăng cao."</span><br><br>
...
slides.append("""
        ...
        <div class="center-layout abs-element dashboard-card chat-box" style="width: 75%; height: auto; padding: 30px; text-align: left; position: relative;">
            <div class="body-text editable draggable" style="font-size: 22pt; line-height: 1.6;">
                Bạn B được giao viết bài văn kể về một trải nghiệm đáng nhớ. Vì sắp đến giờ nộp bài nên B nhờ AI viết hộ. AI viết một bài văn rất hay kể về chuyến đi trượt tuyết ở Sa Pa. Tuy nhiên, giáo viên lại cho B điểm không tốt và phê bình B trước lớp.
                <hr style="border-color: rgba(0, 210, 255, 0.3); margin: 20px 0;">
                <p style="color: #ffeb3b;"><strong>Câu hỏi thảo luận:</strong></p>
                <ul style="margin-left: 30px; font-size: 20pt; line-height: 1.5;">
                    <li>Vì sao giáo viên cho B điểm không tốt và phê bình B?</li>
                    <li>Vì sao giáo viên phát hiện bài văn của B là do AI viết hộ?</li>
                    <li>Theo em, B sai ở điểm nào?</li>
                    <li>Nếu em là B, em sẽ làm khác như thế nào?</li>
                </ul>
            </div>
        </div>
        ...
        <div class="center-layout abs-element dashboard-card" style="width: 80%; text-align: left; border-color: #00ffcc;">
            <div class="body-text editable draggable" style="font-size: 24pt; line-height: 1.8;">
                <ul style="margin-left: 30px;">
                    <li>Sao chép bài AI.</li>
                    <li>Không đúng trải nghiệm.</li>
                    <li>Thiếu trung thực.</li>
                    <li><span style="color: #ffeb3b; font-weight: bold;">Nên dùng AI để gợi ý thay vì viết hộ.</span></li>
                </ul>
            </div>
        </div>
""")
...
slides.append("""
        ...
        <div id="task-modal" class="modal-overlay" style="display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 100; align-items: center; justify-content: center;">
            <div class="dashboard-card" style="width: 70%; text-align: center; background: var(--bg-dark); border-color: #00ffcc; position: relative; padding: 40px;">
                ...
                <h2 style="color: #ffeb3b; font-size: 32pt; margin-bottom: 20px;">NHIỆM VỤ 02</h2>
...
slides.append("""
        ...
        <div class="abs-element dashboard-card chat-box" style="top: 25%; left: 5%; width: 90%; text-align: left; position: relative;">
            <div class="body-text editable draggable" style="font-size: 20pt; line-height: 1.6;">
...
slides.append("""
        ...
        <div class="center-layout abs-element" style="width: 70%; text-align: left;">
            <div class="body-text editable draggable" style="font-size: 24pt; line-height: 1.8;">
                <ul style="margin-left: 30px;">
                    <li>AI giúp người học hiểu bài và phát triển năng lực, không làm thay nhiệm vụ học tập.</li>
                </ul>
            </div>
        </div>
""")
...
slides.append("""
        ...
        <div class="abs-element dashboard-card chat-box" style="top: 25%; left: 10%; width: 80%; text-align: left; position: relative;">
            <div class="body-text editable draggable" style="font-size: 22pt; line-height: 1.8;">
                <p style="color: #ffeb3b; font-weight: bold; margin-bottom: 20px;">Hãy biến các câu lệnh "làm hộ" thành câu lệnh "giúp học":</p>
                <ul style="list-style-type: none; padding: 0;">
                    <li style="margin-bottom: 15px;"><span style="color: #ff3333;">❌ Viết hộ mình bài văn</span> ➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 60%; outline: none;"></li>
                    <li style="margin-bottom: 15px;"><span style="color: #ff3333;">❌ Làm hết bài tập Toán</span> ➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 60%; outline: none;"></li>
                    <li style="margin-bottom: 15px;"><span style="color: #ff3333;">❌ Cho đáp án luôn</span> ➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 60%; outline: none;"></li>
                    <li style="margin-bottom: 15px;"><span style="color: #ff3333;">❌ Trả lời hết câu hỏi</span> ➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 60%; outline: none;"></li>
                </ul>
            </div>
        </div>
        <div class="abs-element timer-container" style="bottom: 5%; left: 50%; transform: translateX(-50%); width: 400px; text-align: center;">
...
slides.append("""
        ...
        <div class="center-layout abs-element" style="width: 70%; text-align: left;">
            <div class="body-text editable draggable" style="font-size: 24pt; line-height: 1.8;">
                <ul style="margin-left: 30px;">
                    <li><span style="color: #ffeb3b; font-weight: bold;">Muốn học chủ động với AI, hãy hỏi để hiểu, không hỏi để chép.</span></li>
                </ul>
            </div>
        </div>
""")
...
slides.append("""
        ...
        <div class="abs-element dashboard-card chat-box" style="top: 25%; left: 10%; width: 80%; text-align: left; position: relative;">
            <div class="body-text editable draggable" style="font-size: 20pt; line-height: 1.6;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 15px; justify-content: center; margin-bottom: 30px;">
                    <div class="alg-block draggable" style="z-index: 10; padding: 10px; background: rgba(0,210,255,0.2); border: 1px solid #00d2ff; border-radius: 5px;">Nêu điều chưa hiểu</div>
                    <div class="alg-block draggable" style="z-index: 10; padding: 10px; background: rgba(0,210,255,0.2); border: 1px solid #00d2ff; border-radius: 5px;">Nhờ AI giải thích</div>
                    <div class="alg-block draggable" style="z-index: 10; padding: 10px; background: rgba(0,210,255,0.2); border: 1px solid #00d2ff; border-radius: 5px;">Tự làm</div>
...
slides.append("""
        ...
        <div class="center-layout abs-element" style="width: 70%; text-align: left;">
            <div class="body-text editable draggable" style="font-size: 24pt; line-height: 1.8;">
                Quy trình 4 bước:
                <ul style="margin-left: 30px;">
                    <li><span style="color: #00ffcc; font-weight: bold;">Bước 1:</span> Nêu điều chưa hiểu</li>
                    <li><span style="color: #00ffcc; font-weight: bold;">Bước 2:</span> Nhờ AI giải thích hoặc gợi ý</li>
                    <li><span style="color: #00ffcc; font-weight: bold;">Bước 3:</span> Tự làm</li>
                    <li><span style="color: #00ffcc; font-weight: bold;">Bước 4:</span> Nhờ AI góp ý</li>
                </ul>
            </div>
        </div>
""")
...
slides.append("""
        ...
        <div class="abs-element dashboard-card chat-box" style="top: 25%; left: 10%; width: 80%; text-align: left; position: relative;">
            <div class="body-text editable draggable" style="font-size: 20pt; line-height: 1.6;">
                <p style="color: #ffeb3b; font-weight: bold; margin-bottom: 20px;">Tình huống: Em sắp viết bài văn: "Kể về người bạn thân." Hãy hoàn thành quy trình:</p>
                <ul style="list-style-type: none; padding: 0;">
                    <li style="margin-bottom: 15px;"><strong>Bước 1:</strong> Nêu điều em chưa hiểu.<br>➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 80%; outline: none;"></li>
                    <li style="margin-bottom: 15px;"><strong>Bước 2:</strong> Viết câu hỏi hoặc yêu cầu gửi AI.<br>➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 80%; outline: none;"></li>
                    <li style="margin-bottom: 15px;"><strong>Bước 3:</strong> Em sẽ tự thực hiện điều gì?<br>➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 80%; outline: none;"></li>
                    <li style="margin-bottom: 15px;"><strong>Bước 4:</strong> Em sẽ nhờ AI góp ý như thế nào?<br>➔ <input type="text" style="background: transparent; border: none; border-bottom: 2px dashed #00ffcc; color: #00ffcc; font-size: 20pt; width: 80%; outline: none;"></li>
                </ul>
            </div>
        </div>
        <div class="abs-element timer-container" style="bottom: 2%; left: 50%; transform: translateX(-50%); width: 400px; text-align: center;">
...
slides.append("""
        ...
        <div class="center-layout abs-element dashboard-card" style="width: 80%; text-align: left; border-color: #00ffcc;">
            <div class="body-text editable draggable" style="font-size: 22pt; line-height: 1.8;">
                Ví dụ:
                <ul style="margin-left: 30px;">
                    <li><span style="color: #ffeb3b; font-weight: bold;">Bước 1:</span> Mình chưa biết mở bài thế nào.</li>
                    <li><span style="color: #ffeb3b; font-weight: bold;">Bước 2:</span> Hãy gợi ý cho mình 3 cách mở bài khi kể về người bạn thân.</li>
                    <li><span style="color: #ffeb3b; font-weight: bold;">Bước 3:</span> Tự viết bài bằng lời văn của mình.</li>
                    <li><span style="color: #ffeb3b; font-weight: bold;">Bước 4:</span> Đây là bài của mình, hãy góp ý giúp mình.</li>
                </ul>
            </div>
        </div>
""")
        ...
        <div class="abs-element dashboard-card" style="top: 25%; left: 10%; width: 80%; padding-bottom: 120px; text-align: left; position: relative;">
            <div class="body-text editable draggable" style="font-size: 22pt;">
                <div class="checkbox-group" style="margin-left: 20px; line-height: 1.8;">
                    <label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span> Em chỉ sử dụng AI để hỗ trợ học tập, không nhờ AI làm thay bài tập.</label><br>
                    <label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span> Em sẽ hỏi AI để hiểu kiến thức, không hỏi để chép đáp án.</label><br>
                    <label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span> Em sẽ tự hoàn thành bài học bằng khả năng của mình trước khi nhờ AI góp ý.</label><br>
                    <label class="custom-checkbox"><input type="checkbox"><span class="checkmark"></span> Em sử dụng AI trung thực, có trách nhiệm và phù hợp với mục đích học tập.</label>
                </div>
            </div>
...
slides.append("""
        ...
        <div class="center-layout abs-element" style="width: 70%; text-align: left;">
            <div class="body-text editable draggable" style="font-size: 24pt; line-height: 1.8;">
                <ul style="margin-left: 30px;">
                    <li style="margin-bottom: 15px;">AI là công cụ hỗ trợ học tập, <span style="color: #ffeb3b; font-weight: bold;">không thể thay thế suy nghĩ và trải nghiệm của người học</span>.</li>
                    <li style="margin-bottom: 15px;">Muốn học chủ động với AI, hãy <span style="color: #ffeb3b; font-weight: bold;">hỏi để hiểu, không hỏi để chép</span>.</li>
                    <li>Quy trình học chủ động cùng AI gồm 4 bước:
                        <div style="color: #00ffcc; font-weight: bold; margin-top: 10px; margin-left: 20px;">
                            Nêu điều chưa hiểu → Nhờ AI giải thích hoặc gợi ý → Tự làm → Nhờ AI góp ý.
                        </div>
                    </li>
                </ul>
            </div>
...
slides.append("""
        ...
        <div class="top-center-layout abs-element" style="top: 10%; width: 100%; z-index: 2;">
            ...
            <div class="subtitle editable draggable" style="font-size: 28pt; margin-top: 15px; max-width: 80%; margin-left: auto; margin-right: auto;">Chúc mừng các chuyên gia công nghệ đã hoàn thành xuất sắc nhiệm vụ. Hãy tiếp tục sử dụng AI thông minh để học tập hiệu quả hơn mỗi ngày!</div>
        </div>
        <div class="abs-element" style="top: 45%; left: 50%; transform: translateX(-50%); z-index: 2; width: 60%; text-align: center;">
            <div style="background: rgba(0, 0, 0, 0.6); padding: 40px; border: 3px solid #ffeb3b; border-radius: 15px; box-shadow: 0 0 30px rgba(255, 235, 59, 0.4);">
                <input type="text" id="team-name-input" placeholder="Nhập tên nhóm kĩ sư xuất sắc..." style="width: 90%; padding: 20px; font-size: 36pt; background: transparent; border: none; border-bottom: 3px dashed #00d2ff; color: #fff; text-align: center; outline: none; margin-bottom: 30px; font-family: 'Inter', sans-serif;">
                <br>
