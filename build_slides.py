...
slides.append("""
        ...
        <div class="abs-element dashboard-card chat-box" style="top: 220px; left: 12.5%; width: 75%; height: auto; padding: 30px; text-align: left; position: absolute;">
            <div class="body-text editable draggable" style="font-size: 22pt; line-height: 1.6;">
                Bạn Bách được giao viết bài văn kể về một trải nghiệm đáng nhớ. Vì sắp đến giờ nộp bài nên Bách nhờ AI viết hộ. AI viết một bài văn rất hay kể về chuyến đi trượt tuyết ở Sa Pa. Tuy nhiên, giáo viên lại cho Bách điểm không tốt và phê bình Bách trước lớp.
                ...
                <ul style="margin-left: 30px; font-size: 20pt; line-height: 1.5;">
                    ...
                    <li>Theo em, Bách sai ở điểm nào?</li>
                    <li>Nếu em là Bách, em sẽ làm khác như thế nào?</li>
                </ul>
            </div>
        </div>
...
slides.append("""
        <div class="top-center-layout abs-element" style="top: 5%; width: 100%;">
            <div class="title editable draggable" style="font-size: 40pt;">Thử nghiệm quy trình<br>học chủ động</div>
...
slides.append("""
        <div class="top-center-layout abs-element" style="top: 5%; width: 100%;">
            <div class="title editable draggable" style="font-size: 40pt;">NHẬT KÝ CHUYÊN GIA</div>
...
slides.append("""
        <div class="top-center-layout abs-element" style="top: 5%; width: 100%;">
            ...
            <div class="subtitle editable draggable" style="font-size: 24pt; margin-top: 5px; color: #ffeb3b;">Hãy sử dụng AI đúng cách để trở thành người học chủ động mỗi ngày!</div>
        </div>
...
slides.append("""
        ...
        <div class="top-center-layout abs-element" style="top: 5%; width: 100%; z-index: 2;">
            ...
            <div class="subtitle editable draggable" style="font-size: 20pt; margin-top: 10px; max-width: 80%; margin-left: auto; margin-right: auto; line-height: 1.4;">Chúc mừng các chuyên gia công nghệ đã hoàn thành xuất sắc nhiệm vụ. Hãy tiếp tục sử dụng AI thông minh để học tập hiệu quả hơn mỗi ngày!</div>
        </div>
        <div class="abs-element dashboard-card" style="top: 260px; left: 50%; transform: translateX(-50%); z-index: 2; width: 60%; text-align: center; padding: 25px 30px; box-sizing: border-box; border: 2px solid #ffeb3b;">
            ...
            <div style="display: flex; align-items: center; justify-content: center; font-size: 22pt; color: #fff; gap: 10px;">
                <span>Nhóm:</span>
                <input type="text" id="team-name-input" placeholder="Nhập tên nhóm kĩ sư xuất sắc..." style="width: 250px; padding: 5px 10px; font-size: 22pt; background: transparent; border: none; border-bottom: 2px dashed #00d2ff; color: #fff; text-align: center; outline: none; font-family: 'Inter', sans-serif;">
            </div>
